...
public final class AndroidTournaments extends Tournaments {
	public AndroidTournaments(Context context) {
		// 1) Change the project's package identifier from "com.badlogicgames.superjumper" to your own domain (for example "com.mycompany.superjumper") in the project's AndroidManifest.xml.
		// 2) Navigate to https://developers.nextpeer.com and create your Android game.
		// 3) In the game setting your own domain's package identifier (see step #1)
